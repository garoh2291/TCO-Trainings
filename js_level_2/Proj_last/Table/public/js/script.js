...
const myStaff = function(){
    let some = JSON.parse(localStorage.getItem('staff'))
    if(some === null){
        return [
            {
                id: '1',
...
addbtn.onclick = function(e){
    ...
    myStaff().push(obj)
    console.log(myStaff()[myStaff().length - 1]);
    localStorage.setItem('staff',JSON.stringify(myStaff()))
