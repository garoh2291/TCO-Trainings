...
let someId = navigationConfig.find(item => item)

console.log(someId.id);
console.log(someId.title);
console.log(someId.translate);
console.log(someId.type);
console.log(someId.icon);


let someChild = someId.children.filter(child => child.id == "dashboards")

let someUrl = someChild.find(item => item)
let myUrl =  someUrl.children
